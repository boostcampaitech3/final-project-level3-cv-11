...
from web.fastapi_engine.detection import mtcnn_detection, mtcnn_get_embeddings, mtcnn_recognition, load_face_db
...
def Recognition(img, bboxes, args, model_args):
    ...
    faces, unknown_embeddings = mtcnn_get_embeddings(model_args['Detection'],
