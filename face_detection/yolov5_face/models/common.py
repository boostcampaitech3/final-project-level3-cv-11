...
from face_detection.yolov5_face.yolo_utils.general import non_max_suppression, make_divisible, scale_coords, xyxy2xywh
from face_detection.yolov5_face.yolo_utils.plots import color_list
