...
class Args(object):
    ...
    parser.add_argument('--input_mode', type=int, default=2, help='cv2: 0, PIL: 1, torchvision: 2')
    parser.add_argument('--detector', type=str, default='mtcnn1', help='Detection model')
