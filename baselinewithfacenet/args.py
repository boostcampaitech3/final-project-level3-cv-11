...
class Args(object):
    ...
    parser.add_argument('--video_dir', default="../data/dest_images/kakao/song.mp4", help='Directory to video')
    ...
    parser.add_argument('--detector', type=str, default='retinaface', help='Detection model: retinaface')
